  ...
  const getPageColors = () => {
    ...
    if (activeSection === "services") {
      ...
      return {
        ...
        bg: "rgba(235,248,255,0.62)",

        darkBg: "rgba(3,35,55,0.74)",
    ...
    if (activeSection === "why-us") {
      ...
      return {
        ...
        bg: "rgba(245,240,255,0.64)",

        darkBg: "rgba(30,20,50,0.74)",
    ...
    if (activeSection === "industries") {
      ...
      return {
        ...
        bg: "rgba(232,245,250,0.64)",

        darkBg: "rgba(4,30,42,0.76)",
    ...
    >
      ...
      >
        ...
        {/* =================================================
            ...
            Does not create a huge expensive animation.
